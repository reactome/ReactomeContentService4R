...
```{r get-token, include=FALSE, eval=T}
# specify token & id here so that the vignette doesn't need to install ReactomeGSA & ReactomeGSA.data
token <- "MjAyMDEwMDIxNTUwNDVfMjc3Ng%3D%3D"
id <- "R-HSA-163200"
```
