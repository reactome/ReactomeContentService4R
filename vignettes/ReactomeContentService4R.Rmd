...
# specify token & id here so that the user needs not to install ReactomeGSA & ReactomeGSA.data
...
```{r diagram}
exportImage(id = id, output = "diagram", format = "png", token = token, quality = 7)
```
