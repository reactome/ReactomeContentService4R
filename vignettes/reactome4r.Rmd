...
Now that we have got all those disease pathways, we can look into what disease(s) associated with a pathway of your interest, which is one of the attributes of this pathway.
...
```{r getMapping}
p53.pathways <- getMapping(id = "TP53", resource = "HGNC", species = "human")
head(p53.pathways, 5)
```
